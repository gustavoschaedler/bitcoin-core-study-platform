const translations = {
  "pt-BR": {
    ...
    wallet_title: "Laboratório de carteira",
    wallet_text: "Crie carteiras, gere endereços e gerencie chaves.",
    signing_title: "Laboratório de assinatura",
    signing_text: "Crie PSBTs, assine e transmita transações.",
  ...
  "en-GB": {
    ...
    wallet_title: "Wallet lab",
    wallet_text: "Create wallets, derive addresses and manage keys.",
    signing_title: "Signing lab",
    signing_text: "Create PSBTs, sign and broadcast transactions.",
