const translations = {
  "pt-BR": {
    ...
    nav_home:"Início", nav_faucet:"Faucet", nav_mempool:"Mempool", nav_wallet:"Carteira", nav_stats:"Stats", nav_docs:"Docs", nav_display:"Display", nav_terminal:"Terminal", nav_last_refresh:"Última atualização", language:"Idioma", brand_subtitle:"Plataforma de estudo do Core"
  },
  "en-GB": {
    ...
    nav_home:"Home", nav_faucet:"Faucet", nav_mempool:"Mempool", nav_wallet:"Wallet", nav_stats:"Stats", nav_docs:"Docs", nav_display:"Display", nav_terminal:"Terminal", nav_last_refresh:"Last refresh", language:"Language", brand_subtitle:"Core study platform"
  }
};
...
if(settingsToggle && settingsPopover){
  settingsToggle.addEventListener("click", () => {
    const next = !settingsPopover.hidden;
    settingsPopover.hidden = next;
...
load();
const _refreshMs = (parseInt(document.body.dataset.refreshInterval, 10) || 30) * 1000;
